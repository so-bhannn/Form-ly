...
const FormCard = ({
    ...
    return(
        <div className="flex flex-col h-60 lg:min-w-1/2 justify-center rounded-lg outline-1 outline-gray-200 shadow-sm p-8 gap-2">
            ...
            <div className='flex gap-5'>
                <a href={`form/edit/`}><Button content='Edit' black={false} ></Button></a>
