...
export default function QuestionCard({
    ...
    return (
        <div className="flex w-full rounded-lg border border-gray-200">
            {/* Drag handle */}
            <div className="opacity-50 flex items-center justify-center w-10">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 cursor-grab">
