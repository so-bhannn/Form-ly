            ...
            <div className="flex flex-row w-full ">
                <aside className="sm:flex flex-col justify-between bg-gray-50 min-w-70 max-w-70 h-[calc(100vh-64px)] border-r-1 border-gray-200 box-border hidden font-medium fixed overflow-y-auto">
                    <div className="px-4">
                        ...
                        <a href="/templates" className={`flex gap-2.5 items-center w-full rounded-lg px-2.5 py-2.5 my-2.5 text-md ${pathname===`/templates` ? 'bg-gray-100 text-black/80' : 'text-black/60'} hover:bg-gray-100 hover:text-black/80 hover:cursor-pointer`}><i className='bx bxs-file-image text-2xl'></i><h1>Templates</h1></a>
                    </div>
